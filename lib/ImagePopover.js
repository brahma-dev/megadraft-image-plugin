  ...
  _createClass(ImageComponent, [{
    ...
    value: function render() {
      ...
      var icons = ICONS.map(function (icon, index) {
        var fill = _this2.props.width === icon.width ? '#14a8d5' : '#fff';
        var style = { fill: fill };
...
var styles = _aphrodite.StyleSheet.create({
  ...
  reference: (_reference = {
    ...
    background: 'black',
    'border-radius': '5px'
  }, _defineProperty(_reference, 'background', '#303030'), _defineProperty(_reference, 'boxShadow', '0 3px 10px 0 rgba(0,0,0,0.3)'), _defineProperty(_reference, 'border', '3px solid rgba(0,0,0,0.1)'), _defineProperty(_reference, 'textAlign', 'center'), _defineProperty(_reference, 'zIndex', '2'), _defineProperty(_reference, 'padding', '10px'), _defineProperty(_reference, 'display', 'flex'), _defineProperty(_reference, 'width', '120px'), _defineProperty(_reference, 'justifyContent', 'space-between'), _reference)
});